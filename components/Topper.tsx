  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <motion.div 
          className="p-8 text-gray-800 flex flex-col items-center bg-green-50 justify-center"
        ...
        >
          <div className="bg-green-50 rounded-lg shadow-md border border-gren-100 p-4 min-w-full overflow-hidden">
